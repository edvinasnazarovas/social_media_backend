...
function editUser(req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        var sql, hashedPassword, values, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    sql = "UPDATE user SET name = ?, lastname = ?, username = ?, password = ?, email = ? WHERE ID = ?";
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
                ...
                case 2:
                    ...
                    values = [req.body.name, req.body.lastname, req.body.username, hashedPassword, req.body.email,
                        req.params.id];
                    db_1.db.query(sql, values, function (err, result) {
                        if (err) {
...
module.exports = { fetchUsers: fetchUsers, editUser: editUser };
